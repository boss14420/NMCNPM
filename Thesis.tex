...
\title  {Báo cáo môn học Trí tuệ nhân tạo}
\authors {
    {Vũ Văn Hiệp - 20101545}{} \\
    {Nguyễn Đức Tuấn - 20102430}{} \\
    {Lê Đức Thịnh - 20102246}{} \\
    {Nguyễn Duy Thành - 20102737}{} \\
}
\supervisor  {TS. Lê Thanh Hương}
...
\date       {\today}
\subject    {Đề 5 - Viết chương trình nhận dạng chữ viết dùng mạng neuron}
\keywords   {}
...
{
\textbf{ANN} & \textbf{A}rtifical \textbf{N}eural \textbf{N}etwork: Mạng neuron
nhân tạo \\
% \textbf{Acronym} & \textbf{W}hat (it) \textbf{S}tands \textbf{F}or \\
\textbf{SOM} & \textbf{S}elf-\textbf{O}rganizing \textbf{M}ap: Ánh xạ tự tổ
chức\\
}
